...
class IndustriesControllerTest < ActionController::TestCase
  ...
  test "should create industry" do
    assert_difference('Industry.count') do
      post :create, industry: { description: @industry.description, header: @industry.header, name: @industry.name }
    end
  ...
  test "should update industry" do
    patch :update, id: @industry, industry: { description: @industry.description, header: @industry.header, name: @industry.name }
    assert_redirected_to industry_path(assigns(:industry))
  end
